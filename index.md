...
She works at the intersection of software engineering and human computer interaction. She is always passionate on addressing real-life problems that can actually impact people's daily life. My main research topics are around **software usability** and **UI engineering**. The main goal of her research is to use human-centred technique to examine and ensure responsible software development by design. She is currently working on dark pattern detection, data visualisation, UI design search and generation, and mobile application accessibility enhancement.
